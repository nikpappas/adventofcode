...
public class Day20ParticleSwarm {
    ...
    public static void main(String[] args) {
        Day20ParticleSwarm app = new Day20ParticleSwarm(INPUTS + "/day20.txt");
    ...
    private void sortParts() {
        particles = particles.stream().sorted(Comparator.comparingInt(Particle::getManDist)).collect(Collectors.toList());
    }
    ...
    private static List<Particle> parseParticles(String path) {
        List<String> input = Utils.readFile(path).collect(Collectors.toList());
